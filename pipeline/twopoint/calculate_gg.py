...
def compute_ht(options):
	...
	if splitflag:
		print('22')
		c2c2 = compute_gg(cat2,cat2,options)
		print('12')
		c1c2 = compute_gg(cat1,cat2,options)
		print('12')
		c2c1 = compute_gg(cat2,cat1,options)
...
def compute_gg(cat1, cat2, options):
