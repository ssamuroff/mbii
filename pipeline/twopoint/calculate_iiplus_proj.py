...
def compute(options):
	...
	print('11')
	cat1 = data[mask]
	c1c1 = compute_iiplus(cat1, cat1, options, period=period[options['simulation']]) 
	...
	if splitflag:
		print('22')
		c2c2 = compute_iiplus(cat2, cat2, options, rpbins=rpbins, period=period[options['simulation']])
	
		print('12')
		c1c2 = compute_iiplus(cat1, cat2, options, rpbins=rpbins, period=period[options['simulation']])
		print('21')
		c2c1 = compute_iiplus(cat2, cat1, options, rpbins=rpbins, period=period[options['simulation']])
		...
		print('00')
		cat0 = data
		c0c0 = compute_iiplus(cat0, cat0, options, rpbins=rpbins, period=period[options['simulation']])
