...
def compute(options):
	...
	F11,R11 = errors.jackknife('ed', cat1, cat1, cat1_sym, cat1_sym, options) 
	...
	if splitflag:
		print('22')
		F22,R22 = errors.jackknife('ed', cat2, cat2, cat2_sym, cat2_sym, options, rbins=rbins)
	
		print('12')
		F12,R12 = errors.jackknife('ed', cat1, cat2, cat1_sym, cat2_sym, options, rbins=rbins)
		print('21')
		F21,R21 = errors.jackknife('ed', cat2, cat1, cat2_sym, cat1_sym, options, rbins=rbins)
		...
		print('00')
		cat0 = data
		F00,R00 = errors.jackknife('ed', cat0, cat0, cat0_sym, cat0_sym, options, rbins=rbins, period=period[options['simulation']])
