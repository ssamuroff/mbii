...
def compute(options, binning):
	...
	if splitflag:
		...
		print('11')
		F11,R11 = errors.jackknife('ii_plus_projected', cat1, cat1, cat1_sym, cat1_sym, options, nbins=binning)
		export_array('%s/IIplus_proj_var_11%s.txt'%(options['2pt']['savedir'], suffix), rbins, F11, R11)

		print('22')
		F22,R22 = errors.jackknife('ii_plus_projected', cat2, cat2, cat2_sym, cat2_sym, options, nbins=binning)
		export_array('%s/IIplus_proj_var_22%s.txt'%(options['2pt']['savedir'], suffix), rbins, F22, R22)
	
		print('12')
		F12,R12 = errors.jackknife('ii_plus_projected', cat1, cat2, cat1_sym, cat2_sym, options, nbins=binning)
		print('21')
		F21,R21 = errors.jackknife('ii_plus_projected', cat2, cat1, cat2_sym, cat1_sym, options, nbins=binning)
	...
	cat0 = data
	cat0_sym = data_sym
	F00,R00 = errors.jackknife('ii_plus_projected', cat0, cat0, cat0_sym, cat0_sym, options, nbins=binning)
