...
baryons_symm = util.gather_mpi_output('/home/ssamurof/massive_black_ii/cats/symmetrised/*-masswtdmedian-stellarmasscut.fits', hdu='baryons')
...
baryons1,baryons_symm = di.match_results(baryons1, baryons_symm, name1='lambda1',name2='lambda1')
print baryons1.size, baryons_symm.size

nmax=300
# The two catalogues hardcoded here should have identical selection functions
select = (baryons1['npart']>nmax) & (np.isfinite(baryons1['x']) & np.isfinite(baryons1['y']) & np.isfinite(baryons1['z'])) & (baryons1['x']<100000) & (baryons1['y']<100000) & (baryons1['z']<100000) & (baryons1['x']>0) & (baryons1['y']>0) & (baryons1['z']>0)
...
mask2 = (baryons_symm['c3']!=0) & (baryons_symm['npart']>nmax)
...
plt.savefig('/home/ssamurof/etae_baseit-log-symm-smc%d.png'%nmax)
